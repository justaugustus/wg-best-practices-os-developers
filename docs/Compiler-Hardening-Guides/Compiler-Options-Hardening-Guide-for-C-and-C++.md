...
| [`-fhardened`](#-fhardened)                                                               | GCC 14                             | Enable pre-determined set of hardening options in GCC                                        |
...
| Compiler Flag                             | Supported since | Description                                                         |
|:----------------------------------------- |:---------------:|:------------------------------------------------------------------- |
| <span id="-fhardened">`-fhardened`</span> | GCC 14          | Enable pre-determined set of hardening options for C and C++ in GCC |

The `-fhardened` umbrella option enables a pre-determined set of hardening options for C and C++ on GNU/Linux targets[^gcc-fhardened]. The precise set of foptions may change between major releases of GCC. The exact set of options for a specific GCC version can be displayed using the `--help=hardened` option.

In GCC 14, the set of options are:

|:--------------------------------------------------------------- |
| [`-D_FORTIFY_SOURCE=3`](#-D_FORTIFY_SOURCE=3)                   |
| [`-D_GLIBCXX_ASSERTIONS`](#-D_GLIBCXX_ASSERTIONS)               |
| [`-ftrivial-auto-var-init=zero`](#-ftrivial-auto-var-init) |
| [`-fPIE -pie`](#-fPIE_-pie)                                     |
| [`-Wl,-z,relro,-z,now`]((#-Wl,-z,relro))                        |
| [`-fstack-protector-strong`](#-fstack-protector-strong)         |
| [`-fstack-clash-protection`](#-fstack-clash-protection)         |
| [`-fcf-protection=full`](#-fcf-protection=full)   (x86_64 only) |
